...
public class Fruit extends FoodItem{
	...
	/**
	 * @author Owner : this the default constructor for Fruit class
	 */
	public Fruit() {
		super();
		orchardName = null;
	...
	/**
	 * @return : this toString method returns formated string with Orchard name
	 */
	@Override
	public String toString() {
		String output;
		output = String.format("Item: %2d %2s %2d, price: $%2.2f cost: %2.2f, orchard supplier: %2s %n", itemCode, itemName, itemQuantityInStock, itemPrice, itemCost, orchardName);
		return output;
	}
